...
class ClusterPointAnnotationExample extends StatefulWidget implements Example {
  const ClusterPointAnnotationExample();

  @override
  State<StatefulWidget> createState() => ClusterPointAnnotationExampleState();
  
  @override
  Widget get leading => const Icon(Icons.layers_outlined);

    @override
  String get title => 'Cluster Annotations';
...
class ClusterPointAnnotationExampleState
    extends State<ClusterPointAnnotationExample> {
  ClusterPointAnnotationExampleState();
